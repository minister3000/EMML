...
RcppExport SEXP _EMML_LogLikeliHood_FULL(SEXP paramSEXP, SEXP dataxSEXP, SEXP n_explanatorySEXP, SEXP n_transitionSEXP, SEXP prob_initial_state_0SEXP, SEXP printLogLikeSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _EMML_LogLikeliHood(SEXP paramSEXP, SEXP dataxSEXP, SEXP n_explanatorySEXP, SEXP n_transitionSEXP, SEXP prob_initial_state_0SEXP, SEXP printLogLikeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type param(paramSEXP);
...
RcppExport SEXP _EMML_LogLikeliHood_byObs(SEXP paramSEXP, SEXP dataxSEXP, SEXP n_explanatorySEXP, SEXP n_transitionSEXP, SEXP prob_initial_state_0SEXP, SEXP printLogLikeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type param(paramSEXP);
...
RcppExport SEXP _EMML_LogLikeliHood_min(SEXP paramSEXP, SEXP dataxSEXP, SEXP n_explanatorySEXP, SEXP n_transitionSEXP, SEXP prob_initial_state_0SEXP, SEXP printLogLikeSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type param(paramSEXP);
...
RcppExport SEXP _EMML_LogLikeliHood_RunTimeCheck(SEXP paramSEXP, SEXP dataxSEXP, SEXP n_explanatorySEXP, SEXP n_transitionSEXP, SEXP prob_initial_state_0SEXP, SEXP printLogLikeSEXP, SEXP n_itSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Rcpp::NumericVector >::type param(paramSEXP);
...
// ReturnTiny
double ReturnTiny();
RcppExport SEXP _EMML_ReturnTiny() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
// rcpp_hello
List rcpp_hello();
RcppExport SEXP _EMML_rcpp_hello() {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
static const R_CallMethodDef CallEntries[] = {
    {"_EMML_LogLikeliHood_FULL", (DL_FUNC) &_EMML_LogLikeliHood_FULL, 6},
    {"_EMML_LogLikeliHood", (DL_FUNC) &_EMML_LogLikeliHood, 6},
    {"_EMML_LogLikeliHood_byObs", (DL_FUNC) &_EMML_LogLikeliHood_byObs, 6},
    {"_EMML_LogLikeliHood_min", (DL_FUNC) &_EMML_LogLikeliHood_min, 6},
    {"_EMML_LogLikeliHood_RunTimeCheck", (DL_FUNC) &_EMML_LogLikeliHood_RunTimeCheck, 7},
    {"_EMML_ReturnTiny", (DL_FUNC) &_EMML_ReturnTiny, 0},
    {"_EMML_rcpp_hello", (DL_FUNC) &_EMML_rcpp_hello, 0},
    {NULL, NULL, 0}
};

RcppExport void R_init_EMML(DllInfo *dll) {
